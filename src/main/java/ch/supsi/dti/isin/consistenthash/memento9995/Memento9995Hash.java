...
/**
 * Wrapper to adapt the {@link Memento9995Engine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class Memento9995Hash implements ConsistentHash
{
     ...
     */
    private final Memento9995Engine engine;
     ...
     */
    public Memento9995Hash( Collection<? extends Node> initNodes )
    {
     ...
     */
    public Memento9995Hash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {

        super();

        final int size = Require.nonEmpty( initNodes, "The cluster must have at least one node" ).size();
        this.engine = new Memento9995Engine(
                size, 
