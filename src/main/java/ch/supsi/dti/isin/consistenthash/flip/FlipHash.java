...
/**
 * Wrapper to adapt the {@link FlipEngine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class FlipHash implements ConsistentHash
{


    /**
     * The {@code FlipHash} algorithm engine as described in:
     ...
     */
    public FlipHash( Collection<? extends Node> nodes )
    {
     ...
     */
    public FlipHash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {
