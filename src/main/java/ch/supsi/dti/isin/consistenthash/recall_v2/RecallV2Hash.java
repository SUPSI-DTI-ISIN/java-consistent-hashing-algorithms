...
/**
 * Wrapper to adapt the {@link RecallV2Engine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class RecallV2Hash implements ConsistentHash
{
     ...
     * {@code TBD}
     */
    private final RecallV2Engine engine;
     ...
     */
    public RecallV2Hash( Collection<? extends Node> initNodes )
    {
     ...
     */
    public RecallV2Hash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {

        super();

        final int size = Require.nonEmpty( initNodes, "The cluster must have at least one node" ).size();
        this.engine = new RecallV2Engine(
                size, 
