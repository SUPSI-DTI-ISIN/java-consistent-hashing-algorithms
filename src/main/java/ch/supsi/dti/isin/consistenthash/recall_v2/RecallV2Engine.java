 ...
 */
public class RecallV2Engine implements BucketBasedEngine
{ 
    ...
    private final HashTableV2<Replacement> R;

    /** The hash table storing the replacement chains in reverse order. */
    private final HashTableV2<Pointer> I;
    ...
    */
     ...
     */
    public RecallV2Engine( int size, HashFunction hashFunction )
    {
        ...
        this.l = size;
        this.n = size;
        this.R = new HashTableV2<>();
        this.I = new HashTableV2<>();
    ...
    public int addBucket()
    {
        ...
        /*
         * By construction, b is the last bucket of its
         * replacement chain. Since it has been restored,
         * it becomes the replacing bucket of the chain.
         */
        b_rep.head.r = b;
    ...
    public int removeBucket( int b )
    {
        ...
        /*
         * If b was the replacement of a previously removed bucket,
         * the replacement of b becomes the last of the replacement
         * chain.
         */
        final Replacement b_rep;
        final Pointer p = I.get( b );
        if( p != null )
        {
            /*
             * If a bucket is pointing b, then it must
             * have been removed before b. Therefore,
             * there must exist a replacement for it.
             */
            final Replacement rep = R.get( p.value );

            /* 
             * The bucket replacing b becomes the new
             * replacing bucket for the whole chain.
             * The chain head is the replacement storing
             * the replacement bucket for all the chain.
             * Therefore. we update it.
             */
            rep.head.r = r_b;

            /* 
             * Finally, we create the replacement for b
             * to add to the replacement set.
             */
            b_rep = new Replacement( b, w_b, l, rep.head );
        ...
        else
        {
            ...
            /*
             * If b is not the replacing bucket of any 
             * previously removed bucket, then it is
             * the head of a new replacement chain.
             */
            b_rep = new ChainHead( b, r_b, w_b, l );
