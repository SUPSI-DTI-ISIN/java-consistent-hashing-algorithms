 ...
 */
class HashTableV2<E extends HashTableV2.Entry>
{
    ...
    static class Replacement extends Entry
    {
        ...
        /** The first replacement of the chain. */
         ...
         * @param head the head of the replacement chain
         */
        Replacement( int b, int w, int p, ChainHead head )
        {
         ...
         * @param p the previous removed bucket
         */
        Replacement( int b, int w, int p )
        {
            
            super( b );

            this.head = (ChainHead) this;
            this.w = w;
            this.p = p;
    ...
    /**
     * Represents the head of a replacement chain.
     * In addition to a common replacement, the head
     * stores the replacement for all the elements
     * in the chain.
     */
    static class ChainHead extends Replacement
    {
         ...
         * @param p the previous removed bucket
         */
        ChainHead( int b, int r, int w, int p )
        {
