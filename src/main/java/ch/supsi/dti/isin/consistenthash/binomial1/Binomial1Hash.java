...
/**
 * Wrapper to adapt the {@link Binomial1Engine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class Binomial1Hash implements ConsistentHash
{
     ...
     * {@code N/A}
     */
    private final Binomial1Engine engine;
     ...
     */
    public Binomial1Hash( Collection<? extends Node> nodes )
    {
     ...
     */
    public Binomial1Hash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {
        ...
        this.engine = new Binomial1Engine(
            size,
