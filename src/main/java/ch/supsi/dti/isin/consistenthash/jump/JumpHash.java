...
/**
 * Wrapper to adapt the {@link JumpEngine} to the {@link ConsistentHash} interface.
 * 
 ...
 */
public class JumpHash implements ConsistentHash
{


    /**
     * The {@code JumpHash} algorithm engine as described in:
     * {@code https://arxiv.org/pdf/1406.2294.pdf}
     */
    private final JumpEngine engine;
     ...
     */
    public JumpHash( Collection<? extends Node> nodes )
    {
     ...
     */
    public JumpHash( Collection<? extends Node> initNodes, HashFunction hashFunction )
    {
