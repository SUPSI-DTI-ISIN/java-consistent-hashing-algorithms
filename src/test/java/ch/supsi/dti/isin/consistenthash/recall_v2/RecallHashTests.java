...
/**
 * Test suite for the class {@link RecallV2Hash}.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class RecallHashTests implements ConsistentHashContract<RecallV2Hash>
{
     ...
     */
    @Override
    public RecallV2Hash sampleValue( Collection<? extends Node> nodes )
    {

        return new RecallV2Hash( nodes );
    ...
    public void initial_nodes_cannot_be_null()
    {
        ...
        assertThrows(
            RequirementFailure.class,
            () -> new RecallV2Hash( Collections.singletonList(null) )
        );
