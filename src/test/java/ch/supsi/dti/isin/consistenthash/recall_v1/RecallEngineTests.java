...
/**
 * Test suite for the class {@link RecallV1Engine}.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class RecallEngineTests implements Contract<RecallV1Engine> {
    ...
    /**
     * Creates a new {@link RecallV1Engine} with the given size.
     * 
     * @param size size of the cluster
     * @return new instance of {@link RecallV1Engine}
     */
    public RecallV1Engine sampleValue(int size) {

        return new RecallV1Engine(size, ConsistentHash.DEFAULT_HASH_FUNCTION);
     ...
     */
    @Override
    public RecallV1Engine sampleValue() {
    ...
    public void a_new_created_engine_should_have_the_expected_size() {
        ...
        final RecallV1Engine engine = sampleValue(size);
    ...
    public void if_the_cluster_has_one_bucket_all_the_keys_should_land_to_such_a_bucket() {
        ...
        final RecallV1Engine engine = sampleValue(1);
    ...
    public void if_the_cluster_has_multiple_buckets_each_bucket_should_get_some_key() {
        ...
        final RecallV1Engine engine = sampleValue();
    ...
    private void recordKeyPositions(List<String> keys, int iteration, Map<String, int[]> map, RecallV1Engine engine) {
