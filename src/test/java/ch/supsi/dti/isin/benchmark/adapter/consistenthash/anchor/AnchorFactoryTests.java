...
/**
 * Suite to test the {@link AnchorFactory} class.
 * 
 * @author Massimo Coluzzi
 */
@DisplayNameGeneration(DisplayNameGenerator.ReplaceUnderscores.class)
public class AnchorFactoryTests implements ConsistentHashFactoryContract<AnchorFactory>
{
     ...
     */
    @Override
    public AnchorFactory sampleValue( AlgorithmConfig config )
    {

        return new AnchorFactory( config );
    ...
    public void passing_empty_configuration_should_take_default_capacity()
    {
        ...
        final AnchorFactory factory = sampleValue( CONFIG );
        
        final Supplier<AnchorEngine> supplier = factory.createEngineInitializer( FUNCTION, NODES );
        assertNotNull( supplier );

        final AnchorEngine engine = supplier.get();
